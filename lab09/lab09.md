...
#### Вопросы
![alt-text](images/ping%20terminal.png)
1. Каков IP-адрес вашего хоста? Каков IP-адрес хоста назначения?
   - 192.168.0.3
   - 151.101.1.164
2. Почему ICMP-пакет не обладает номерами исходного и конечного портов?
   - Потому что ICMP это протокол сетевого уровня. Общение происходит между хостами, а не процессами
3. Рассмотрите один из ping-запросов, отправленных вашим хостом. Каковы ICMP-тип и кодовый
   ...
   - Контрольная сумма, идентификатор, порядковый номер и таймстемп
   - по 2 байта каждый
   - ![alt-text](images/ping%20request.png)
4. Рассмотрите соответствующий ping-пакет, полученный в ответ на предыдущий. 
   ...
   - Контрольная сумма, идентификатор, порядковый номер и таймстемп
   - по 2 байта каждый
   - ![alt-text](images/ping%20reply.png)
...
1. Рассмотрите ICMP-пакет с эхо-запросом на вашем скриншоте. Отличается ли он от ICMP-пакетов
   ...
   - Отличается только тем, что на него нет ответа и заданным ttl
   - ![alt-text](images/traceroute%20request.png)
2. Рассмотрите на вашем скриншоте ICMP-пакет с сообщением об ошибке. В нем больше полей,
   ...
   - Информация о прошлом ICMP запросе: его заголовок, контрольная сумма, идентификатор и порядковый номер
   - ![alt-text](images/traceroute%20error.png)
3. Рассмотрите три последних ICMP-пакета, полученных исходным хостом. Чем эти пакеты
   ...
   - На них есть ответы
   - Это объясняется тем, что мы дошли до точки назначения
   - ![alt-text](images/traceroute%20success.png)
4. Есть ли такой канал, задержка в котором существенно превышает среднее значение? Можете
   ...
   - Между 7 и 9
   - Можно предположить (и потом проверить), что `prs` это Париж, а `nyk` Нью-Йорк. То есть запрос шел через океан
   - ![alt-text](images/traceroute%20terminal.png)
